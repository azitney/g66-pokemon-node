...
module.exports = {
  ...
  index:function(req, res){
    if(req.session.playerone && req.session.playertwo){
      ...
      .then((result)=>{
        ...
        .then((resultTwo)=>{
          res.render('gym/index', {playerone: result[0], playertwo: resultTwo[0], battle: 'yes'})
        })
      ...
      .then((result)=>{
        ...
        .where('in_gym', false)
        .then((resultTwo)=>{
          res.render('gym/index', {playerone: result[0], playertwo: 'no', battle: 'no', pokemon: resultTwo})
        })
      ...
      .then((result)=>{
        ...
        .where('in_gym', false)
        .then((resultTwo)=>{
          res.render('gym/index', {playerone: 'no', playertwo: result[0], battle: 'no', pokemon: resultTwo})
        })
      ...
      .where("in_gym", false)
      .then((result)=>{
        res.render('gym/index', {playerone: 'no', playertwo: 'no', battle: 'no', pokemon: result});
      })
  ...
  battle: function(req, res){
    ...
    .then(()=>{
      ...
      res.render('gym/winner', {pokemon: pokemon, message: message})
    })
